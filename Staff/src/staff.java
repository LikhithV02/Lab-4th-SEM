...
class Teaching extends Staff {
    ...
    public Teaching(String staffid, String name, String phone, double salary, String domain, int cntpub) {
        super(staffid, name, phone, salary);
        this.domain = domain;
        this.publications = cntpub;
    }
    ...
    public void display() {
        ...
        super.display();
        System.out.println("Domain: " + getDomain() + " Publications: " + getPublications());
        System.out.println();
    }
}
